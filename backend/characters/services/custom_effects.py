...
EFFECT_TARGET_LABELS = {
    ...
    "forgia_tetto_miglioramenti": "Tetto miglioramenti (Potenziato)",
    "forgia_miglioramenti_specialista": "Miglioramenti extra sul materiale scelto",
    "forgia_miglioramenti_stanchezza": "Miglioramento extra per Stanchezza",
    "forgia_bonus_frecce": "Bonus base delle frecce forgiate",
    "forgia_uso_pratico": "Livello di Uso pratico",
    "forgia_puo_fondere": "Può fondere oggetti",
    "forgia_puo_riplasmare": "Può riplasmare il materiale",
    "forgia_puo_ovunque": "Può forgiare ovunque",
    "incanta_livello_max_oggetti": "Livello massimo incantamento oggetti",
    "incanta_livello_max_pergamene": "Livello massimo pergamene",
    "incanta_mana_per_livello": "Mana per livello di incantamento",
    "incanta_cariche_percento": "Cariche per oggetto (%)",
    "incanta_max_effetti": "Incantamenti per oggetto",
    "incanta_puo_reincantare": "Può reincantare oggetti esistenti",
    "incanta_puo_sommare_gemme": "Può sommare più gemme",
    "incanta_puo_disincantare": "Può disincantare",
    "incanta_bonus_livello_stanchezza": "Livello incantamento extra per Stanchezza",
...
EFFECT_ICON_ASSET_ALIASES = {
    ...
    "tier": "tier_extra", "sifone_di_mana": "sifone_di_mana_extra", "ogni_en_x_mana": "ogni_en_x_mana_ordine_extra",
